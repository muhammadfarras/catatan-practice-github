...
JIka kita ingin menge-check pekerjaan hal baru didalam sebuah submodule, kita dapat menuju ke direktori projek submodule tersebut dan jalankan perintah `git fetch` dan `git merge` the upstream branch untuk memperbarui code lokal.
